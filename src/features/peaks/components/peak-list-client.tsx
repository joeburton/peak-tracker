              ...
              <li key={peak.id}>
                {userId ? (
                  <button
                    ...
                    className="group flex w-full items-center justify-between gap-4 py-3 pr-2 text-left transition-colors hover:bg-muted/50 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring focus-visible:rounded"
                  >
                    {rowContent}
                  </button>
                ) : (

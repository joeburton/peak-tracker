...
const { verify, EXPECTED_WAINWRIGHTS, EXPECTED_MUNROS, EXPECTED_TOTAL, UK_LAT, UK_LNG } =
...
describe('exported constants', () => {
  ...
  it('EXPECTED_TOTAL is the sum', () =>
    expect(EXPECTED_TOTAL).toBe(EXPECTED_WAINWRIGHTS + EXPECTED_MUNROS));
